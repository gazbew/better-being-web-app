...
export const products: Product[] = [
  {
    ...
    rating: 4.6,
    reviews: 73,
    benefits: ["Pain Relief, Anti-Inflammatory".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["MSM, Magnesium, Herbal Extract Blend, Essential Oils".split(', ')].map(i => i.replace(/"/g, '')),
    ...
    inStock: true,
    stockCount: 67,
    tags: ["bone,-joint-and-muscle", "energy-and-fitness", "products-under-r250", "nutrition-and-supplements".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 2,
    ...
    rating: 4.7,
    reviews: 96,
    benefits: ["Skin Health".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Herbal Extract Blend, Essential Oils".split(', ')].map(i => i.replace(/"/g, '')),
    ...
    inStock: true,
    stockCount: 84,
    tags: ["products-under-r250", "skin-and-beauty", "products-under-r250", "skin-and-beauty".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 3,
    ...
    rating: 4.8,
    reviews: 119,
    benefits: ["General Wellness, Natural Support".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Natural Ingredients, Herbal Blend".split(', ')].map(i => i.replace(/"/g, '')),
    ...
    inStock: true,
    stockCount: 101,
    tags: ["nutrition-and-supplements", "products-under-r250", "recipes", "products-under-r250".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 4,
    ...
    inStock: true,
    stockCount: 118,
    tags: ["services", "gut-health", "services", "services".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 5,
    ...
    rating: 4.5,
    reviews: 165,
    benefits: ["Pain Relief".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Natural Ingredients, Herbal Blend".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "wellness-essentials",
    ...
    inStock: true,
    stockCount: 135,
    tags: ["products-under-r250", "respiratory-health", "gut-health", "products-under-r250".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 6,
    ...
    inStock: true,
    stockCount: 152,
    tags: ["nutrition-and-supplements", "products-under-r250", "recipes", "mens-health".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 7,
    ...
    rating: 4.7,
    reviews: 211,
    benefits: ["Immune Support".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Natural Ingredients, Herbal Blend".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "digital-products",
    subcategoryId: "ebooks",
    ...
    inStock: true,
    stockCount: 169,
    tags: ["immunity", "products-under-r250", "products-under-r250", "skin-and-beauty".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 8,
    ...
    rating: 4.8,
    reviews: 234,
    benefits: ["Digestive Health, Gut Health".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Probiotic Strains".split(', ')].map(i => i.replace(/"/g, '')),
    ...
    inStock: true,
    stockCount: 186,
    tags: ["gut-health", "immunity", "products-under-r250", "bone,-joint-and-muscle".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 9,
    ...
    reviews: 257,
    benefits: ["Pain Relief".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Herbal Extract Blend".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "wellness-essentials",
    subcategoryId: "respiratory",
    ...
    inStock: true,
    stockCount: 203,
    tags: ["respiratory-health", "products-under-r250", "respiratory-health".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 10,
    ...
    inStock: true,
    stockCount: 220,
    tags: ["gut-health", "services", "services", "gut-health".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 11,
    ...
    reviews: 326,
    benefits: ["Digestive Health, Gut Health".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Probiotic Strains, Herbal Extract Blend".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "digital-products",
    subcategoryId: "ebooks",
    ...
    inStock: true,
    stockCount: 54,
    tags: ["gut-health", "products-under-r250", "nutrition-and-supplements", "products-under-r250".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 13,
    ...
    rating: 4.8,
    reviews: 349,
    benefits: ["Gut Health".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Probiotic Strains, Essential Oils".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Take 1 capsule daily on an empty stomach, preferably in the morning.",
    categoryId: "wellness-essentials",
    subcategoryId: "multivitamins",
    ...
    inStock: true,
    stockCount: 71,
    tags: ["farming".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 14,
    ...
    inStock: true,
    stockCount: 88,
    tags: ["nutrition-and-supplements", "products-under-r250", "recipes", "gut-health".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 15,
    sku: "OG-FLUCOMBO-015",
    name: "Flu Combo",
    ...
    rating: 4.5,
    reviews: 395,
    benefits: ["Gut Health, Immune Support".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Probiotic Strains".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "wellness-essentials",
    subcategoryId: "multivitamins",
    ...
    inStock: true,
    stockCount: 105,
    tags: ["immunity", "gut-health", "immunity", "products-under-r250".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 16,
    ...
    rating: 4.6,
    reviews: 418,
    benefits: ["Anti-Aging".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Collagen Peptides".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "digital-products",
    subcategoryId: "ebooks",
    ...
    inStock: false,
    stockCount: 122,
    tags: ["nutrition-and-supplements", "nutrition-and-supplements", "skin-and-beauty", "nutrition-and-supplements".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 17,
    ...
    inStock: true,
    stockCount: 139,
    tags: ["nutrition-and-supplements", "products-under-r250", "recipes", "nutrition-and-supplements".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 18,
    ...
    inStock: true,
    stockCount: 156,
    tags: ["gut-health", "gut-health", "products-under-r250", "gut-health".split('", "').map(t => t.replace(/"/g, ''))]
  },  {
    id: 19,
    ...
    reviews: 510,
    benefits: ["General Wellness, Natural Support".split(', ')].map(b => b.replace(/"/g, '')),
    ingredients: ["Essential Oils".split(', ')].map(i => i.replace(/"/g, '')),
    usage: "Follow package directions or consult with healthcare provider.",
    categoryId: "natural-skincare",
    subcategoryId: "skincare",
    ...
    inStock: true,
    stockCount: 190,
    tags: ["skin-and-beauty", "products-under-r250", "skin-and-beauty", "skin-and-beauty".split('", "').map(t => t.replace(/"/g, ''))]
  }
];
